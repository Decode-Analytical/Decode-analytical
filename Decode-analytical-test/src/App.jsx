...
import ViewPage from './pages/instructorProfile/ViewPage'
import ReplyPage from './pages/instructorProfile/ReplyPage'
import LikesPage from "./pages/instructorProfile/LikesPage";
