...
import MyCart from "./pages/Carts$Payments/MyCart";
import CheckoutCart from "./pages/Carts$Payments/CheckoutCart";
import Message from "./pages/Studentmessage/Message";
        ...
        <div className=" flex justify-between relative">
          <div className="flex-1">
            ...
            <Routes>
              ...
              <Route />
              {/* student Routing */}
              <Route path='/studentDashboard' element={<StudentIndex />}>
                <Route index element={<StudentDashboard />} />
                <Route path="/studentDashboard/courses" element={<StudentCourses/>}/>
                <Route path="/studentDashboard/cart" element={<MyCart/>}/>
                <Route path="/studentDashboard/checkout" element={<CheckoutCart/>}/>
                <Route path="/studentDashboard/messages" element={<Message/>}/>
              </Route>
