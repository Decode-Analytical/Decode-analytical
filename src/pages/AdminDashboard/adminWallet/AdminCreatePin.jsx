...
import { createPinSchema } from "../../../schema/createPin";
...
const AdminCreatePin = () => {
  ...
  const formHook = useForm({
    resolver: (data) => {
      return createPinSchema.validate(data, { abortEarly: false }).then(
        () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await Axios.post(urls.adminGeneratePin, data, {
        headers: {
