            ...
            <div>
                <div className=''>
                    <TopCourseCard
                        ...
                        things={`Completed Course(${completed?.length}) `}
                    />
                    <div className='flex w-[100%] gap-12 mt-4 overflow-auto items-center justify-center'>
                        { completed?.length > 0 ?(
                            completed?.map((element, index)=>(

                                <CourseFrame key={index}
                                imageProp={element.image[0].path}
                                second={element.module_duration}
