        ...
        <div className="flex gap-3 my-5">
          <div className="md:w-2/6">
            <h2
              ...
              style={{ fontSize: "5.25rem", lineHeight: "4.25rem" }}
            >
              4.0
            </h2>
            <div>
              <div className="flex gap-2 justify-around">
                {array.map((value, index) => {
                  ...
                  return (
                    ...
                    >
                      <AiFillStar
                        color={rantingValue <= rating ? "#ffc107" : "#e4e5e9"}
                        size={25}
                      />
                    </button>
                  );
              ...
              <h3 className="text-[#ffc107] text-xl text-center">
                Course Rating
              </h3>
            </div>
          </div>
          <div className="w-full gap-1 flex flex-col">
            {CreateBar.map((value, index) => {
              ...
              return <BarComment barwidth={value} ratingvalue={ratingValue} />;
            })}
          </div>
        </div>
