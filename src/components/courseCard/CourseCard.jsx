...
const CourseCard = () => {
  ...
  return (
    <>
    <div class="max-w-sm w-full lg:max-w-full lg:flex course-card">
      <div class="h-48 lg:h-auto lg:w-80 flex-none bg-cover rounded text-center overflow-hidden img-container" title="Woman holding a mug">
      </div>
      <div class="bg-white flex flex-col flex-1 justify-between leading-normal">
        <div class="mb-1 mt-6 lg:mx-4 lg:mt-0 flex flex-col justify-between">
          <h3 class="text-gray-900 font-bold text-xl mb-2 ">Can coffee make you a better developer?</h3>
          ...
          <div className='flex flex-col flex-1 '>
            ...
            <div class="flex items-center mt-5 mb-4">
              <img class="w-10 h-10 rounded-full mr-4" src="https://resize.prod.femina.ladmedia.fr/rblr/1200,806/img/var/2023-03/cool-girl-crop.jpg" alt="Avatar of Jonathan Reinink"/>
              <div class="text-sm">
                <p class="text-gray-500 leading-none text-center m-0">by Jonathan Reinink</p>
              </div>
            </div>
            ...
            <div class="flex items-center">
                ...
                <p class="m-0 text-sm font-medium text-gray-500 dark:text-gray-400 text-center">4.95 (24)</p>
            </div>
