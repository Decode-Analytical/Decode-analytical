...
const AdminSidebar = ({ name, imgURL }) => {
  ...
  return (
    <>
      ...
      bg-gray-900 text-white ${
        !menuOpened && "left-[-80px]"
      } md:left-0 profile-sidebar 
      ...
      >
        ...
        <div className="flex flex-col items-center pt-2 profile-sidebar-heading">
          ...
          >
            ...
            <div className="text-sm my-1">Reg. Student</div>
            <button className="border my-1 px-4 py-2 rounded-md text-xs border-gray-600 text-white hover:bg-gray-600 hover:text-white">
              Edit Profile
            </button>
          </div>
        </div>
        ...
        <ul className="flex flex-col gap-1 mt-2 profile-sidebar-options">
          {listOptions.map((el) => {
            return (
              <li
                key={el.title}
                className={`flex flex-row cursor-pointer duration-300 ${
                  menuOpened && "mx-6 px-1"
                } `}
              >
                <NavLink
                  to={el.url}
                  className={({ isActive }) =>
                    `flex-1 duration-300 hover:bg-cyan-600 hover:font-semibold rounded-sm hover:text-cyan-950 hover:fill-cyan-950 ${
                      menuOpened ? "py-3 px-8" : "mx-2 py-2"
                    } ${!isActive && "fill-white"} ${
                      isActive &&
                      "bg-cyan-600 text-cyan-950 fill-cyan-950 font-bold"
                    }`
                  }
                >
                  <span
                    className={`flex flex-row flex-1 gap-3 m-auto ${
                      !menuOpened && "justify-center"
                    }`}
                  >
                    {/* Icons */}
                    <>
                      ...
                      {el.url == "/dashboard/help" && (
                        ...
                        >
                          ...
                          >
                            ...
                            />
                            <path
                              d="M10.9993 13.5686V11.3464C11.6586 11.3464 12.3031 11.1509 12.8513 10.7846C13.3994 10.4183 13.8267 9.89772 14.0789 9.28863C14.3312 8.67955 14.3973 8.00932 14.2686 7.36272C14.14 6.71612 13.8225 6.12217 13.3564 5.656C12.8902 5.18982 12.2963 4.87236 11.6497 4.74374C11.003 4.61512 10.3328 4.68113 9.72374 4.93342C9.11465 5.18572 8.59406 5.61296 8.22778 6.16112C7.86151 6.70929 7.66602 7.35375 7.66602 8.01302"
                              stroke="black"
                              strokeWidth="2"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                    ...
                    <span
                      className={`duration-300 ${
                        !menuOpened && "w-0 h-0 overflow-hidden"
                      }`}
                    >
                      {el.title}
                    </span>
